...
namespace bugLog.Views
{
    public class UserProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,TeamId,UserName,UserPassword,DisplayName,EmailAddress,AllowEmailNotification,Id,CreatedAt")] UserProfile userProfile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,TeamId,UserName,UserPassword,DisplayName,EmailAddress,AllowEmailNotification,Id,CreatedAt")] UserProfile userProfile)
        {
